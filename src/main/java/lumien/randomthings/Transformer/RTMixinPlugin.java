...
import static lumien.randomthings.Transformer.TargetedMod.VANILLA;
...
public class RTMixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        return mixinClassName.equals("RTBlockLeavesBaseMixin") && VanillaChanges.FASTER_LEAVEDECAY
                || mixinClassName.equals("RTEntityRendererMixin")
                || mixinClassName.equals("RTWorldMixin")
                || mixinClassName.equals("RTItemMixin")
                || mixinClassName.equals("RTRenderGlobalMixin");
    }
